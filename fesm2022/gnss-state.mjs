...
class StateService {
            ...
            for (const obj of objArray) {
                ...
                if (typeof obj === 'object' && obj !== null && keyName in obj) {
                    ...
                    if (typeof objName === 'string' || typeof objName === 'number') {
                        this.groups[groupName][objName] = new BehaviorSubject(castedObj);
                    }
                }
            }
        }
     ...
     */
    observe(subjectName, groupName = null) {
        if (!groupName) {
            if (!this.dir[subjectName]) {
     ...
     */
    reset(subjectName, groupName = null) {
        if (!groupName) {
            if (this.dir[subjectName] && this.backups[subjectName]) {
                const backupObjCopy = JSON.parse(JSON.stringify(this.backups[subjectName]));
        ...
        if (groupName) {
            if (this.groups[groupName] &&
                ...
                const backupObjCopy = JSON.parse(JSON.stringify(this.groupBackups[groupName][subjectName]));
     ...
     */
    set(subjectName, initialValue, groupName = null) {
        let value;
        if (value) {
        ...
        if (groupName) {
            ...
            if (!this.groups[groupName][subjectName]) {
                this.groups[groupName][subjectName] = new BehaviorSubject(value);
            }
            else {
     ...
     */
    value(subjectName, groupName = null) {
        if (!groupName && this.dir[subjectName]) {
            if (this.dir[subjectName].value) {
                const valueClone = JSON.parse(JSON.stringify(this.dir[subjectName].value));
                return valueClone;
            }
     ...
     */
    update(subjectName, newValue, groupName = null) {
        let valueCopy;
        if (newValue) {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.12", ngImport: i0, type: StateService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.12", ngImport: i0, type: StateService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.12", ngImport: i0, type: StateService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
export { StateService };
//# sourceMappingURL=gnss-state.mjs.map
